let e,t,n,i,r,s,o,a,l,h,c,u,d,p,f;function _(e){return e&&e.__esModule?e.default:e}var m,g,v,y,b,C,w,I=globalThis;function E(e){let t=new Date(e);return{date:t.toLocaleDateString("en-GB"),time:t.toLocaleTimeString("en-GB")}}function T(e,t){let n=document.querySelector(t);e?n.style.display="block":n.style.display="none"}function k(e,t=3e3){let n=document.querySelector("#toastContainer")||function(){let e=document.createElement("div");return e.id="toastContainer",document.body.appendChild(e),e}(),i=n.getElementsByClassName("toastMessage");i.length>=3&&i[0].parentNode?.removeChild(i[0]);let r=document.createElement("div");r.classList.add("toastMessage"),r.innerText=e,n.appendChild(r),setTimeout(()=>{r.style.opacity="0",setTimeout(()=>{r.parentNode?.removeChild(r)},500)},t)}function S(e,t){document.querySelectorAll(e).forEach(e=>{e.addEventListener("change",function(){document.querySelectorAll(t).forEach(e=>{e.classList.remove("active")});let e=this.parentElement;e&&e.classList.contains(t.replace(".",""))&&e.classList.add("active")})})}function P(){return Math.floor(1e7*Math.random())}function x(e){return e.charAt(0).toUpperCase()+e.slice(1)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ep=function(e){let t={},n={},i={},r="";try{let s=e.split(".");t=eu(J(s[0])||""),n=eu(J(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:r}},ef=function(e){let t=ep(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},e_=function(e){let t=ep(e).claims;return"object"==typeof t&&!0===t.admin};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ek(e){return e&&e._delegate?e._delegate:e}class eS{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eR=[];(m=C||(C={}))[m.DEBUG=0]="DEBUG",m[m.VERBOSE=1]="VERBOSE",m[m.INFO=2]="INFO",m[m.WARN=3]="WARN",m[m.ERROR=4]="ERROR",m[m.SILENT=5]="SILENT";const eL={debug:C.DEBUG,verbose:C.VERBOSE,info:C.INFO,warn:C.WARN,error:C.ERROR,silent:C.SILENT},eD=C.INFO,eA={[C.DEBUG]:"log",[C.VERBOSE]:"log",[C.INFO]:"info",[C.WARN]:"warn",[C.ERROR]:"error"},eO=(e,t,...n)=>{if(t<e.logLevel)return;let i=new Date().toISOString(),r=eA[t];if(r)console[r](`[${i}]  ${e.name}:`,...n);else throw Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class eM{constructor(e){this.name=e,this._logLevel=eD,this._logHandler=eO,this._userLogHandler=null,eR.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in C))throw TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?eL[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,C.DEBUG,...e),this._logHandler(this,C.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,C.VERBOSE,...e),this._logHandler(this,C.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,C.INFO,...e),this._logHandler(this,C.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,C.WARN,...e),this._logHandler(this,C.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,C.ERROR,...e),this._logHandler(this,C.ERROR,...e)}}const eq=(e,t)=>t.some(t=>e instanceof t),eF=new WeakMap,eH=new WeakMap,eU=new WeakMap,e$=new WeakMap,eB=new WeakMap;let eW={get(e,t,n){if(e instanceof IDBTransaction){if("done"===t)return eH.get(e);if("objectStoreNames"===t)return e.objectStoreNames||eU.get(e);if("store"===t)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return ej(e[t])},set:(e,t,n)=>(e[t]=n,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function ej(n){var i;if(n instanceof IDBRequest)return function(e){let t=new Promise((t,n)=>{let i=()=>{e.removeEventListener("success",r),e.removeEventListener("error",s)},r=()=>{t(ej(e.result)),i()},s=()=>{n(e.error),i()};e.addEventListener("success",r),e.addEventListener("error",s)});return t.then(t=>{t instanceof IDBCursor&&eF.set(t,e)}).catch(()=>{}),eB.set(t,e),t}(n);if(e$.has(n))return e$.get(n);let r="function"==typeof(i=n)?i!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(t||(t=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(i)?function(...e){return i.apply(ez(this),e),ej(eF.get(this))}:function(...e){return ej(i.apply(ez(this),e))}:function(e,...t){let n=i.call(ez(this),e,...t);return eU.set(n,e.sort?e.sort():[e]),ej(n)}:(i instanceof IDBTransaction&&function(e){if(eH.has(e))return;let t=new Promise((t,n)=>{let i=()=>{e.removeEventListener("complete",r),e.removeEventListener("error",s),e.removeEventListener("abort",s)},r=()=>{t(),i()},s=()=>{n(e.error||new DOMException("AbortError","AbortError")),i()};e.addEventListener("complete",r),e.addEventListener("error",s),e.addEventListener("abort",s)});eH.set(e,t)}(i),eq(i,e||(e=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(i,eW):i;return r!==n&&(e$.set(n,r),eB.set(r,n)),r}const ez=e=>eB.get(e),eV=["get","getKey","getAll","getAllKeys","count"],eK=["put","add","delete","clear"],eY=new Map;function eG(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&"string"==typeof t))return;if(eY.get(t))return eY.get(t);let n=t.replace(/FromIndex$/,""),i=t!==n,r=eK.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(r||eV.includes(n)))return;let s=async function(e,...t){let s=this.transaction(e,r?"readwrite":"readonly"),o=s.store;return i&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),r&&s.done]))[0]};return eY.set(t,s),s}eW={...f=eW,get:(e,t,n)=>eG(e,t)||f.get(e,t,n),has:(e,t)=>!!eG(e,t)||f.has(e,t)};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tJ{constructor(e,t,n,i,r=!1,s="",o=!1,a=!1){this.secure=t,this.namespace=n,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this.isUsingEmulator=a,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=t_.get("host:"+e)||this._host}isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&t_.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){let e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}}function tX(e,t,n){let i;if(W("string"==typeof t,"typeof type must == string"),W("object"==typeof n,"typeof params must == object"),t===tG)i=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else if(t===tQ)i=(e.secure?"https://":"http://")+e.internalHost+"/.lp?";else throw Error("Unknown connection type: "+t);(e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams)&&(n.ns=e.namespace);let r=[];return tH(n,(e,t)=>{r.push(e+"="+t)}),i+r.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t3{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){let e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&tW(()=>{this.onMessage_(e[t])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e){this.allowedEvents_=e,this.listeners_={},W(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){let n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});let i=this.getInitialEvent(e);i&&t.apply(n,i)}off(e,t,n){this.validateEventType_(e);let i=this.listeners_[e]||[];for(let e=0;e<i.length;e++)if(i[e].callback===t&&(!n||n===i[e].context)){i.splice(e,1);return}}validateEventType_(e){W(this.allowedEvents_.find(t=>t===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nI{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){let n=new nw(tL,e),i=new nw(tL,t);return 0!==this.compare(n,i)}minPost(){return nw.MIN}}class nE extends nI{static get __EMPTY_NODE(){return n}static set __EMPTY_NODE(e){n=e}compare(e,t){return tA(e.name,t.name)}isDefinedOn(e){throw j("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return nw.MIN}maxPost(){return new nw(tD,n)}makePost(e,t){return W("string"==typeof e,"KeyIndex indexValue must always be a string."),new nw(e,n)}toString(){return".key"}}const nT=new nE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nW extends nI{constructor(e){super(),this.indexPath_=e,W(!np(e)&&".priority"!==no(e),"Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){let n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?tA(e.name,t.name):r}makePost(e,t){let n=nB(e);return new nw(t,nU.EMPTY_NODE.updateChild(this.indexPath_,n))}maxPost(){return new nw(tD,nU.EMPTY_NODE.updateChild(this.indexPath_,n$))}toString(){return nc(this.indexPath_,0).join("/")}}const nj=new /**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nX{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=nA}hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return W(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return(W(this.startSet_,"Only valid if start has been set"),this.startNameSet_)?this.indexStartName_:tL}hasEnd(){return this.endSet_}getIndexEndValue(){return W(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return(W(this.endSet_,"Only valid if end has been set"),this.endNameSet_)?this.indexEndName_:tD}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return W(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===nA}copy(){let e=new nX;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function nZ(e){let t;let n={};if(e.isDefault())return n;if(e.index_===nA?t="$priority":e.index_===nj?t="$value":e.index_===nT?t="$key":(W(e.index_ instanceof nW,"Unrecognized index type!"),t=e.index_.toString()),n.orderBy=ed(t),e.startSet_){let t=e.startAfterSet_?"startAfter":"startAt";n[t]=ed(e.indexStartValue_),e.startNameSet_&&(n[t]+=","+ed(e.indexStartName_))}if(e.endSet_){let t=e.endBeforeSet_?"endBefore":"endAt";n[t]=ed(e.indexEndValue_),e.endNameSet_&&(n[t]+=","+ed(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?n.limitToFirst=e.limit_:n.limitToLast=e.limit_),n}function n0(e){let t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==nA&&(t.i=e.index_.toString()),t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n1 extends nt{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=tT("p:rest:"),this.listens_={}}reportStats(e){throw Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(W(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){let r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);let s=n1.getListenId_(e,n),o={};this.listens_[s]=o;let a=nZ(e._queryParams);this.restRequest_(r+".json",a,(e,t)=>{let a=t;404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(r,a,!1,n),eg(this.listens_,s)===o&&i(e?401===e?"permission_denied":"rest_error:"+e:"ok",null)})}unlisten(e,t){let n=n1.getListenId_(e,t);delete this.listens_[n]}get(e){let t=nZ(e._queryParams),n=e._path.toString(),i=new es;return this.restRequest_(n+".json",t,(e,t)=>{let r=t;404===e&&(r=null,e=null),null===e?(this.onDataUpdate_(n,r,!1,null),i.resolve(r)):i.reject(Error(r))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);let s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n4{constructor(e){this.collection_=e,this.last_=null}get(){let e=this.collection_.get(),t=Object.assign({},e);return this.last_&&tH(this.last_,(e,n)=>{t[e]=t[e]-n}),this.last_=e,t}}class n6{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new n4(e),tj(this.reportStats_.bind(this),Math.floor(1e4+2e4*Math.random()))}reportStats_(){let e=this.statsListener_.get(),t={},n=!1;tH(e,(e,i)=>{i>0&&em(this.statsToReport_,e)&&(t[e]=i,n=!0)}),n&&this.server_.reportStats(t),tj(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}function n9(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function n8(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function n7(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}(g=w||(w={}))[g.OVERWRITE=0]="OVERWRITE",g[g.MERGE=1]="MERGE",g[g.ACK_USER_WRITE=2]="ACK_USER_WRITE",g[g.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ie{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=w.ACK_USER_WRITE,this.source=n9()}operationForChild(e){if(!np(this.path))return W(no(this.path)===e,"operationForChild called for unrelated child."),new ie(nl(this.path),this.affectedTree,this.revert);if(null!=this.affectedTree.value)return W(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{let t=this.affectedTree.subtree(new nr(e));return new ie(ns(),t,this.revert)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ir{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=w.MERGE}operationForChild(e){if(!np(this.path))return W(no(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ir(this.source,nl(this.path),this.children);{let t=this.children.subtree(new nr(e));return t.isEmpty()?null:t.value?new ii(this.source,ns(),t.value):new ir(this.source,ns(),t)}}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class io{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function ia(e,t,n,i,r,s){let o=i.filter(e=>e.type===n);o.sort((t,n)=>(function(e,t,n){if(null==t.childName||null==n.childName)throw j("Should only compare child_ events.");let i=new nw(t.childName,t.snapshotNode),r=new nw(n.childName,n.snapshotNode);return e.index_.compare(i,r)})(e,t,n)),o.forEach(n=>{let i=("value"===n.type||"child_removed"===n.type||(n.prevName=s.getPredecessorChildName(n.childName,n.snapshotNode,e.index_)),n);r.forEach(r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))})})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iM{constructor(){this.changeMap=new Map}trackChildChange(e){let t=e.type,n=e.childName;W("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),W(".priority"!==n,"Only non-priority child changes can be tracked.");let i=this.changeMap.get(n);if(i){let r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,nY(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,nK(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,nV(n,e.snapshotNode));else if("child_changed"===t&&"child_changed"===r)this.changeMap.set(n,nY(n,e.snapshotNode,i.oldSnap));else throw j("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}const iq=new /**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iz{constructor(e,t){this.query_=e,this.eventRegistrations_=[];let n=this.query_._queryParams,i=new nG(n.getIndex()),r=n.loadsAllData()?new nG(n.getIndex()):n.hasLimit()?new nJ(n):new nQ(n);this.processor_={filter:r};let s=t.serverCache,o=t.eventCache,a=i.updateFullNode(nU.EMPTY_NODE,s.getNode(),null),l=r.updateFullNode(nU.EMPTY_NODE,o.getNode(),null),h=new is(a,s.isFullyInitialized(),i.filtersNodes()),c=new is(l,o.isFullyInitialized(),r.filtersNodes());this.viewCache_=il(c,h),this.eventGenerator_=new io(this.query_)}get query(){return this.query_}}function iV(e){return 0===e.eventRegistrations_.length}function iK(e,t,n){let i=[];if(n){W(null==t,"A cancel should cancel all event registrations.");let r=e.query._path;e.eventRegistrations_.forEach(e=>{let t=e.createCancelEvent(n,r);t&&i.push(t)})}if(t){let n=[];for(let i=0;i<e.eventRegistrations_.length;++i){let r=e.eventRegistrations_[i];if(r.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(i+1));break}}else n.push(r)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return i}function iY(e,t,n,i){var r,s;t.type===w.MERGE&&null!==t.source.queryId&&(W(id(e.viewCache_),"We should always have a full cache before handling merges"),W(iu(e.viewCache_),"Missing event cache, even though we have a server cache"));let o=e.viewCache_,a=function(e,t,n,i,r){let s,o;let a=new iM;if(n.type===w.OVERWRITE)n.source.fromUser?s=i$(e,t,n.path,n.snap,i,r,a):(W(n.source.fromServer,"Unknown source."),o=n.source.tagged||t.serverCache.isFiltered()&&!np(n.path),s=iU(e,t,n.path,n.snap,i,r,o,a));else if(n.type===w.MERGE){var l,h;let c;n.source.fromUser?(l=n.path,h=n.children,c=t,h.foreach((n,s)=>{let o=nd(l,n);iB(t,no(o))&&(c=i$(e,c,o,s,i,r,a))}),h.foreach((n,s)=>{let o=nd(l,n);iB(t,no(o))||(c=i$(e,c,o,s,i,r,a))}),s=c):(W(n.source.fromServer,"Unknown source."),o=n.source.tagged||t.serverCache.isFiltered(),s=ij(e,t,n.path,n.children,i,r,o,a))}else if(n.type===w.ACK_USER_WRITE)s=n.revert?function(e,t,n,i,r,s){let o;if(null!=iL(i,n))return t;{let a;let l=new iF(i,t,r),h=t.eventCache.getNode();if(np(n)||".priority"===no(n)){let n;if(t.serverCache.isFullyInitialized())n=ix(i,id(t));else{let e=t.serverCache.getNode();W(e instanceof nU,"serverChildren would be complete if leaf node"),n=iN(i,e)}a=e.filter.updateFullNode(h,n,s)}else{let r=no(n),c=iD(i,r,t.serverCache);null==c&&t.serverCache.isCompleteForChild(r)&&(c=h.getImmediateChild(r)),(a=null!=c?e.filter.updateChild(h,r,c,nl(n),l,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(h,r,nU.EMPTY_NODE,nl(n),l,s):h).isEmpty()&&t.serverCache.isFullyInitialized()&&(o=ix(i,id(t))).isLeafNode()&&(a=e.filter.updateFullNode(a,o,s))}return o=t.serverCache.isFullyInitialized()||null!=iL(i,ns()),ih(t,a,o,e.filter.filtersNodes())}}(e,t,n.path,i,r,a):function(e,t,n,i,r,s,o){if(null!=iL(r,n))return t;let a=t.serverCache.isFiltered(),l=t.serverCache;if(null!=i.value){if(np(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return iU(e,t,n,l.getNode().getChild(n),r,s,a,o);if(!np(n))return t;{let i=new i_(null);return l.getNode().forEachChild(nT,(e,t)=>{i=i.set(new nr(e),t)}),ij(e,t,n,i,r,s,a,o)}}{let h=new i_(null);return i.foreach((e,t)=>{let i=nd(n,e);l.isCompleteForPath(i)&&(h=h.set(e,l.getNode().getChild(i)))}),ij(e,t,n,h,r,s,a,o)}}(e,t,n.path,n.affectedTree,i,r,a);else if(n.type===w.LISTEN_COMPLETE)s=function(e,t,n,i,r){let s=t.serverCache;return iH(e,ic(t,s.getNode(),s.isFullyInitialized()||np(n),s.isFiltered()),n,i,iq,r)}(e,t,n.path,i,a);else throw j("Unknown operation type: "+n.type);let c=a.getChanges();return function(e,t,n){let i=t.eventCache;if(i.isFullyInitialized()){let r=i.getNode().isLeafNode()||i.getNode().isEmpty(),s=iu(e);!(n.length>0)&&e.eventCache.isFullyInitialized()&&(!r||i.getNode().equals(s))&&i.getNode().getPriority().equals(s.getPriority())||n.push(nz(iu(t)))}}(t,s,c),{viewCache:s,changes:c}}(e.processor_,o,t,n,i);return r=e.processor_,W((s=a.viewCache).eventCache.getNode().isIndexed(r.filter.getIndex()),"Event snap not indexed"),W(s.serverCache.getNode().isIndexed(r.filter.getIndex()),"Server snap not indexed"),W(a.viewCache.serverCache.isFullyInitialized()||!o.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=a.viewCache,iG(e,a.changes,a.viewCache.eventCache.getNode(),null)}function iG(e,t,n,i){let r=i?[i]:e.eventRegistrations_;return function(e,t,n,i){let r=[],s=[];return t.forEach(t=>{if("child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)){var n;s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))}}),ia(e,r,"child_removed",t,i,n),ia(e,r,"child_added",t,i,n),ia(e,r,"child_moved",s,i,n),ia(e,r,"child_changed",t,i,n),ia(e,r,"value",t,i,n),r}(e.eventGenerator_,t,n,r)}class iQ{constructor(){this.views=new Map}}function iJ(e,t,n,i){let r=t.source.queryId;if(null!==r){let s=e.views.get(r);return W(null!=s,"SyncTree gave us an op for an invalid query."),iY(s,t,n,i)}{let r=[];for(let s of e.views.values())r=r.concat(iY(s,t,n,i));return r}}function iX(e,t,n,i,r){let s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=ix(n,r?i:null),s=!1;return e?s=!0:(e=i instanceof nU?iN(n,i):nU.EMPTY_NODE,s=!1),new iz(t,il(new is(e,s,!1),new is(i,r,!1)))}return o}function iZ(e){let t=[];for(let n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function i0(e,t){let n=null;for(let i of e.views.values())n=n||function(e,t){let n=id(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!np(t)&&!n.getImmediateChild(no(t)).isEmpty())?n.getChild(t):null}(i,t);return n}function i1(e,t){if(t._queryParams.loadsAllData())return i3(e);{let n=t._queryIdentifier;return e.views.get(n)}}function i2(e){return null!=i3(e)}function i3(e){for(let t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}let i5=1;class i4{constructor(e){this.listenProvider_=e,this.syncPointTree_=new i_(null),this.pendingWriteTree_={visibleWrites:im.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function i6(e,t,n,i,r){var s,o;return(s=e.pendingWriteTree_,o=r,W(i>s.lastWriteId,"Stacking an older write on top of newer ones"),void 0===o&&(o=!0),s.allWrites.push({path:t,snap:n,writeId:i,visible:o}),o&&(s.visibleWrites=ig(s.visibleWrites,t,n)),s.lastWriteId=i,r)?rn(e,new ii(n9(),t,n)):[]}function i9(e,t,n=!1){let i=function(e,t){for(let n=0;n<e.allWrites.length;n++){let i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(!function(e,t){let n=e.allWrites.findIndex(e=>e.writeId===t);W(n>=0,"removeWrite called with nonexistent writeId.");let i=e.allWrites[n];e.allWrites.splice(n,1);let r=i.visible,s=!1,o=e.allWrites.length-1;for(;r&&o>=0;){let t=e.allWrites[o];t.visible&&(o>=n&&function(e,t){if(e.snap)return nm(e.path,t);for(let n in e.children)if(e.children.hasOwnProperty(n)&&nm(nd(e.path,n),t))return!0;return!1}(t,i.path)?r=!1:nm(i.path,t.path)&&(s=!0)),o--}return!!r&&(s?(e.visibleWrites=iS(e.allWrites,ik,ns()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1):i.snap?e.visibleWrites=iy(e.visibleWrites,i.path):tH(i.children,t=>{e.visibleWrites=iy(e.visibleWrites,nd(i.path,t))}),!0)}(e.pendingWriteTree_,t))return[];{let t=new i_(null);return null!=i.snap?t=t.set(ns(),!0):tH(i.children,e=>{t=t.set(new nr(e),!0)}),rn(e,new ie(i.path,t,n))}}function i8(e,t,n){return rn(e,new ii(n8(),t,n))}function i7(e,t,n,i,r=!1){let s=t._path,o=e.syncPointTree_.get(s),a=[];if(o&&("default"===t._queryIdentifier||null!=i1(o,t))){let l=function(e,t,n,i){let r=t._queryIdentifier,s=[],o=[],a=i2(e);if("default"===r)for(let[t,r]of e.views.entries())o=o.concat(iK(r,n,i)),iV(r)&&(e.views.delete(t),r.query._queryParams.loadsAllData()||s.push(r.query));else{let t=e.views.get(r);t&&(o=o.concat(iK(t,n,i)),iV(t)&&(e.views.delete(r),t.query._queryParams.loadsAllData()||s.push(t.query)))}return a&&!i2(e)&&s.push(new(W(c,"Reference.ts has not been loaded"),c)(t._repo,t._path)),{removed:s,events:o}}(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));let h=l.removed;if(a=l.events,!r){let n=-1!==h.findIndex(e=>e._queryParams.loadsAllData()),r=e.syncPointTree_.findOnPath(s,(e,t)=>i2(t));if(n&&!r){let t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){let n=t.fold((e,t,n)=>{if(t&&i2(t))return[i3(t)];{let e=[];return t&&(e=iZ(t)),tH(n,(t,n)=>{e=e.concat(n)}),e}});for(let t=0;t<n.length;++t){let i=n[t],r=i.query,s=ri(e,i);e.listenProvider_.startListening(rh(r),rr(e,r),s.hashFn,s.onComplete)}}}r||!(h.length>0)||i||(n?e.listenProvider_.stopListening(rh(t),null):h.forEach(t=>{let n=e.queryToTagMap.get(rs(t));e.listenProvider_.stopListening(rh(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){let i=t[n];if(!i._queryParams.loadsAllData()){let t=rs(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,h)}return a}function re(e,t,n,i){let r=ro(e,i);if(null==r)return[];{let i=ra(r),s=i.path,o=i.queryId,a=nf(s,t);return rl(e,s,new ii(n7(o),a,n))}}function rt(e,t,n){let i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,(e,n)=>{let i=i0(n,nf(e,t));if(i)return i});return iP(i,t,r,n,!0)}function rn(e,t){var n;return function e(t,n,i,r){if(np(t.path))return function e(t,n,i,r){let s=n.get(ns());null==i&&null!=s&&(i=i0(s,ns()));let o=[];return n.children.inorderTraversal((n,s)=>{let a=i?i.getImmediateChild(n):null,l=iA(r,n),h=t.operationForChild(n);h&&(o=o.concat(e(h,s,a,l)))}),s&&(o=o.concat(iJ(s,t,r,i))),o}(t,n,i,r);{let s=n.get(ns());null==i&&null!=s&&(i=i0(s,ns()));let o=[],a=no(t.path),l=t.operationForChild(a),h=n.children.get(a);if(h&&l){let t=i?i.getImmediateChild(a):null,n=iA(r,a);o=o.concat(e(l,h,t,n))}return s&&(o=o.concat(iJ(s,t,r,i))),o}}(t,e.syncPointTree_,null,(n=e.pendingWriteTree_,iO(ns(),n)))}function ri(e,t){let n=t.query,i=rr(e,n);return{hashFn:()=>(t.viewCache_.serverCache.getNode()||nU.EMPTY_NODE).hash(),onComplete:t=>{if("ok"===t){var r;return i?function(e,t,n){let i=ro(e,n);if(!i)return[];{let n=ra(i),r=n.path,s=n.queryId,o=nf(r,t);return rl(e,r,new it(n7(s),o))}}(e,n._path,i):(r=n._path,rn(e,new it(n8(),r)))}{let i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");let i=Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return i7(e,n,null,i)}}}}function rr(e,t){let n=rs(t);return e.queryToTagMap.get(n)}function rs(e){return e._path.toString()+"$"+e._queryIdentifier}function ro(e,t){return e.tagToQueryMap.get(t)}function ra(e){let t=e.indexOf("$");return W(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new nr(e.substr(0,t))}}function rl(e,t,n){let i=e.syncPointTree_.get(t);return W(i,"Missing sync point for query tag that we're tracking"),iJ(i,n,iO(t,e.pendingWriteTree_),null)}function rh(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(W(u,"Reference.ts has not been loaded"),u)(e._repo,e._path):e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rc{constructor(e){this.node_=e}getImmediateChild(e){return new rc(this.node_.getImmediateChild(e))}node(){return this.node_}}class ru{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){let t=nd(this.path_,e);return new ru(this.syncTree_,t)}node(){return rt(this.syncTree_,this.path_)}}const rd=function(e,t,n){return e&&"object"==typeof e?(W(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"])?rp(e[".sv"],t,n):"object"==typeof e[".sv"]?rf(e[".sv"],t):void W(!1,"Unexpected server value: "+JSON.stringify(e,null,2)):e},rp=function(e,t,n){if("timestamp"===e)return n.timestamp;W(!1,"Unexpected server value: "+e)},rf=function(e,t,n){e.hasOwnProperty("increment")||W(!1,"Unexpected server value: "+JSON.stringify(e,null,2));let i=e.increment;"number"!=typeof i&&W(!1,"Unexpected increment value: "+i);let r=t.node();if(W(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;let s=r.getValue();return"number"!=typeof s?i:s+i},r_=function(e,t,n){return rm(e,new rc(t),n)};function rm(e,t,n){let i;let r=rd(e.getPriority().val(),t.getImmediateChild(".priority"),n);if(!e.isLeafNode())return i=e,r!==e.getPriority().val()&&(i=i.updatePriority(new nD(r))),e.forEachChild(nA,(e,r)=>{let s=rm(r,t.getImmediateChild(e),n);s!==r&&(i=i.updateImmediateChild(e,s))}),i;{let i=rd(e.getValue(),t,n);return i!==e.getValue()||r!==e.getPriority().val()?new nD(i,nB(r)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rE=/[\[\].#$\/\u0000-\u001F\u007F]/,rT=/[\[\].#$\u0000-\u001F\u007F]/,rk=function(e){return"string"==typeof e&&0!==e.length&&!rE.test(e)},rS=function(e){return"string"==typeof e&&0!==e.length&&!rT.test(e)},rP=function(e,t,n,i){i&&void 0===t||rx(eI(e,"value"),t,n)},rx=function(e,t,n){let i=n instanceof nr?new ng(n,e):n;if(void 0===t)throw Error(e+"contains undefined "+ny(i));if("function"==typeof t)throw Error(e+"contains a function "+ny(i)+" with contents = "+t.toString());if(tN(t))throw Error(e+"contains "+t.toString()+" "+ny(i));if("string"==typeof t&&t.length>10485760/3&&eT(t)>10485760)throw Error(e+"contains a string greater than 10485760 utf8 bytes "+ny(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(tH(t,(t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!rk(t)))throw Error(e+" contains an invalid key ("+t+") "+ny(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');i.parts_.length>0&&(i.byteLength_+=1),i.parts_.push(t),i.byteLength_+=eT(t),nv(i),rx(e,s,i),function(e){let t=e.parts_.pop();e.byteLength_-=eT(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)}),n&&r)throw Error(e+' contains ".value" child '+ny(i)+" in addition to actual children.")}},rN=function(e,t,n,i){if((!i||void 0!==n)&&!rS(n))throw Error(eI(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},rR=function(e,t,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),rN(e,t,n,i)},rL=function(e,t){if(".info"===no(t))throw Error(e+" failed = Can't modify data under /.info/")},rD=function(e,t){var n;let i=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!rk(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==i.length&&((n=i)&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),!rS(n)))throw Error(eI(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rA{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function rO(e,t){let n=null;for(let i=0;i<t.length;i++){let r=t[i],s=r.getPath();null===n||n_(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function rM(e,t,n){rO(e,n),function(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){let r=e.eventLists_[i];r&&(t(r.path)?(function(e){for(let t=0;t<e.events.length;t++){let n=e.events[t];if(null!==n){e.events[t]=null;let i=n.getEventRunner();tC&&tE("event: "+n.toString()),tW(i)}}}(e.eventLists_[i]),e.eventLists_[i]=null):n=!1)}n&&(e.eventLists_=[]),e.recursionDepth_--}(e,e=>nm(e,t)||nm(t,e))}class rq{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new rA,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=n3(),this.transactionQueueTree_=new rg,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function rF(e){let t=e.infoData_.getNode(new nr(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function rH(e){var t;return(t=t={timestamp:rF(e)}).timestamp=t.timestamp||new Date().getTime(),t}function rU(e,t,n,i,r){e.dataUpdateCount++;let s=new nr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r){if(i){let t=ey(n,e=>nB(e));o=function(e,t,n,i){let r=ro(e,i);if(!r)return[];{let i=ra(r),s=i.path,o=i.queryId,a=nf(s,t),l=i_.fromObject(n);return rl(e,s,new ir(n7(o),a,l))}}(e.serverSyncTree_,s,t,r)}else{let t=nB(n);o=re(e.serverSyncTree_,s,t,r)}}else if(i){let t=ey(n,e=>nB(e));o=function(e,t,n){let i=i_.fromObject(n);return rn(e,new ir(n8(),t,i))}(e.serverSyncTree_,s,t)}else{let t=nB(n);o=i8(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=rV(e,s)),rM(e.eventQueue_,a,o)}function r$(e,t){rB(e,"connected",t),!1===t&&function(e){rj(e,"onDisconnectEvents");let t=rH(e),n=n3();n5(e.onDisconnect_,ns(),(i,r)=>{let s=rm(r,new ru(e.serverSyncTree_,i),t);!function e(t,n,i){if(np(n))t.value=i,t.children.clear();else if(null!==t.value)t.value=t.value.updateChild(n,i);else{let r=no(n);t.children.has(r)||t.children.set(r,n3()),e(t.children.get(r),n=nl(n),i)}}(n,i,s)});let i=[];n5(n,ns(),(t,n)=>{i=i.concat(i8(e.serverSyncTree_,t,n));let r=rQ(e,t);rV(e,r)}),e.onDisconnect_=n3(),rM(e.eventQueue_,ns(),i)}(e)}function rB(e,t,n){let i=new nr("/.info/"+t),r=nB(n);e.infoData_.updateSnapshot(i,r);let s=i8(e.infoSyncTree_,i,r);rM(e.eventQueue_,i,s)}function rW(e){return e.nextWriteId_++}function rj(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),tE(n,...t)}function rz(e,t,n){return rt(e.serverSyncTree_,t,n)||nU.EMPTY_NODE}function rV(e,t){let n=rK(e,t),i=rI(n),r=rY(e,n);return function(e,t,n){if(0===t.length)return;let i=[],r=[],s=t.filter(e=>0===e.status).map(e=>e.currentWriteId);for(let o=0;o<t.length;o++){let a=t[o],l=nf(n,a.path),h=!1,c;if(W(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===a.status)h=!0,c=a.abortReason,r=r.concat(i9(e.serverSyncTree_,a.currentWriteId,!0));else if(0===a.status){if(a.retryCount>=25)h=!0,c="maxretry",r=r.concat(i9(e.serverSyncTree_,a.currentWriteId,!0));else{let n=rz(e,a.path,s);a.currentInputSnapshot=n;let i=t[o].update(n.val());if(void 0!==i){rx("transaction failed: Data returned ",i,a.path);let t=nB(i);"object"==typeof i&&null!=i&&em(i,".priority")||(t=t.updatePriority(n.getPriority()));let o=a.currentWriteId,l=r_(t,n,rH(e));a.currentOutputSnapshotRaw=t,a.currentOutputSnapshotResolved=l,a.currentWriteId=rW(e),s.splice(s.indexOf(o),1),r=(r=r.concat(i6(e.serverSyncTree_,a.path,l,a.currentWriteId,a.applyLocally))).concat(i9(e.serverSyncTree_,o,!0))}else h=!0,c="nodata",r=r.concat(i9(e.serverSyncTree_,a.currentWriteId,!0))}}rM(e.eventQueue_,n,r),r=[],h&&(t[o].status=2,setTimeout(t[o].unwatcher,Math.floor(0)),t[o].onComplete&&("nodata"===c?i.push(()=>t[o].onComplete(null,!1,t[o].currentInputSnapshot)):i.push(()=>t[o].onComplete(Error(c),!1,null))))}rG(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)tW(i[e]);(function e(t,n=t.transactionQueueTree_){if(n||rG(t,n),ry(n)){let i=rY(t,n);W(i.length>0,"Sending zero length transaction queue"),i.every(e=>0===e.status)&&function(t,n,i){let r=rz(t,n,i.map(e=>e.currentWriteId)),s=r,o=r.hash();for(let e=0;e<i.length;e++){let t=i[e];W(0===t.status,"tryToSendTransactionQueue_: items in queue should all be run."),t.status=1,t.retryCount++;let r=nf(n,t.path);s=s.updateChild(r,t.currentOutputSnapshotRaw)}let a=s.val(!0);t.server_.put(n.toString(),a,r=>{rj(t,"transaction put response",{path:n.toString(),status:r});let s=[];if("ok"===r){let r=[];for(let e=0;e<i.length;e++)i[e].status=2,s=s.concat(i9(t.serverSyncTree_,i[e].currentWriteId)),i[e].onComplete&&r.push(()=>i[e].onComplete(null,!0,i[e].currentOutputSnapshotResolved)),i[e].unwatcher();rG(t,rv(t.transactionQueueTree_,n)),e(t,t.transactionQueueTree_),rM(t.eventQueue_,n,s);for(let e=0;e<r.length;e++)tW(r[e])}else{if("datastale"===r)for(let e=0;e<i.length;e++)3===i[e].status?i[e].status=4:i[e].status=0;else{tP("transaction at "+n.toString()+" failed: "+r);for(let e=0;e<i.length;e++)i[e].status=4,i[e].abortReason=r}rV(t,n)}},o)}(t,rI(n),i)}else rC(n)&&rw(n,n=>{e(t,n)})})(e,e.transactionQueueTree_)}(e,r,i),i}function rK(e,t){let n;let i=e.transactionQueueTree_;for(n=no(t);null!==n&&void 0===ry(i);)i=rv(i,n),n=no(t=nl(t));return i}function rY(e,t){let n=[];return function e(t,n,i){let r=ry(n);if(r)for(let e=0;e<r.length;e++)i.push(r[e]);rw(n,n=>{e(t,n,i)})}(e,t,n),n.sort((e,t)=>e.order-t.order),n}function rG(e,t){let n=ry(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,rb(t,n.length>0?n:void 0)}rw(t,t=>{rG(e,t)})}function rQ(e,t){let n=rI(rK(e,t)),i=rv(e.transactionQueueTree_,t);return!function(e,t,n){let i=e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,t=>{rJ(e,t)}),rJ(e,i),!function e(t,n,i,r){i&&!r&&n(t),rw(t,t=>{e(t,n,!0,r)}),i&&r&&n(t)}(i,t=>{rJ(e,t)}),n}function rJ(e,t){let n=ry(t);if(n){let i=[],r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(W(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(W(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(i9(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,Error("set"),!1,null))));-1===s?rb(t,void 0):n.length=s+1,rM(e.eventQueue_,rI(t),r);for(let e=0;e<i.length;e++)tW(i[e])}}const rX=function(e,t){let n=rZ(e),i=n.namespace;"firebase.com"===n.domain&&tS(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),i&&"undefined"!==i||"localhost"===n.domain||tS("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||tx();let r="ws"===n.scheme||"wss"===n.scheme;return{repoInfo:new tJ(n.host,n.secure,i,r,t,"",i!==n.subdomain),path:new nr(n.pathString)}},rZ=function(e){let t="",n="",i="",r="",s="",o=!0,a="https",l=443;if("string"==typeof e){let h=e.indexOf("//");h>=0&&(a=e.substring(0,h-1),e=e.substring(h+2));let c=e.indexOf("/");-1===c&&(c=e.length);let u=e.indexOf("?");-1===u&&(u=e.length),t=e.substring(0,Math.min(c,u)),c<u&&(r=/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t){if(e.uid)throw Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');let n=t||"demo-project",i=e.iat||0,r=e.sub||e.user_id;if(!r)throw Error("mockUserToken must contain 'sub' or 'user_id' field!");let s=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},e);return[Q(JSON.stringify({alg:"none",type:"JWT"})),Q(JSON.stringify(s)),""].join(".")}(i.mockUserToken,e.app.options.projectId))),r=s,o.repoInfo_=new tJ(`${t}:${n}`,!1,o.repoInfo_.namespace,o.repoInfo_.webSocketOnly,o.repoInfo_.nodeAdmin,o.repoInfo_.persistenceKey,o.repoInfo_.includeNamespaceInQueryParams,!0),r&&(o.authTokenProvider_=r)}(n,...e)}return n}(e9({apiKey:"AIzaSyDpPuITTDAXymL2UCcisK-nGdAAU0",authDomain:"fe23-slutprojekt-userdb.firebaseapp.com",projectId:"fe23-slutprojekt-userdb",databaseURL:"https://fe23-slutprojekt-userdb-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"fe23-slutprojekt-userdb.appspot.com",messagingSenderId:"1056096098177",appId:"1:1056096098177:web:716d9daa8907b6bb1d7a80",measurementId:"G-SJNLBSDKQ7"})),sl="usersv2";async function sh(){let e=r8(sa,sl);try{let t=await si(e);if(!t.exists())return[];{let e=[];return t.forEach(t=>{let n=t.val();e.push(n)}),e}}catch(e){return k("Kunde inte hämta användare, testa igen",5e3),[]}}async function sc(e){let t=r8(sa,sl);try{if(await sf(e.name)){k("Användarnamnet finns redan",5e3);return}await se(t,e)}catch(e){k("Kunde inte skapa användare, testa igen",5e3),console.log(e)}}async function su(e){let t=await s_(e.name);if(console.log(t),t){let n=r8(sa,`${sl}/${t}`);try{await sn(n,e)}catch(e){k("Kunde inte uppdatera användare, testa igen",5e3),console.log(e)}}else k("Användare hittades inte",5e3)}async function sd(e){let t=await s_(e),n=r8(sa,`${sl}/${t}`);try{await st(n)}catch(e){k("Kunde inte ta bort användare, testa igen",5e3),console.log(e)}}async function sp(e,t){let n=r8(sa,sl),i=await si(n);if(!i.exists())return!1;{let n=!1;return i.forEach(i=>{let r=i.val();r.name===e&&r.password===t&&(n=!0)}),n}}async function sf(e){let t=r8(sa,sl),n=await si(t);if(!n.exists())return!1;{let t=!1;return n.forEach(n=>{n.val().userName===e&&(t=!0)}),t}}async function s_(e){let t=r8(sa,sl),n=await si(t);if(!n.exists())return k("Kunde inte hitta användare, testa igen",5e3),null;let i=null;return n.forEach(t=>{if(t.val().name===e)return i=t.key,!0}),i}const sm={isInputEmpty:e=>!e.trim(),isUserNameValid:e=>/^[A-Za-z0-9_]+$/.test(e),isPasswordValid:e=>e.length>=6,isPasswordMatch:(e,t)=>e===t,isUserNameTaken:async e=>!!(await sh()).find(t=>t.name===e)};async function sg(e){let t=document.querySelector("#userName"),n=document.querySelector("#password");if(!t||!n)return;let i=t.value,r=n.value;if(sm.isInputEmpty(i)||sm.isInputEmpty(r)){k("Alla fälten måste vara ifyllda",5e3);return}await sp(i,r)?(localStorage.setItem("login",i),e.navigate(`/user/${i}`),console.log("router",e)):k("Fel användarnamn eller lösenord",5e3)}function sv(e){localStorage.removeItem("login"),e.navigate("/login")}function sy(){return!!localStorage.getItem("login")}function sb(){return localStorage.getItem("login")}var sC={};sC=new URL("black-panther.5ebfe666.png",import.meta.url).toString();var sw={};sw=new URL("red-panda.2102a999.png",import.meta.url).toString();var sI={};sI=new URL("babirusa.78f33283.png",import.meta.url).toString();const sE=e=>{let t;let n=document.querySelector(".mainMenu"),i=document.querySelector("#topMenuUser");if(!n||!i)return;let r=sy(),s=sb();t=r&&s?`<a href=/user/${s} data-navigo>Se profilsida</a>`:'<a href="/login" data-navigo>Logga in</a>',n.innerHTML=`
  <ul class="menu">
    <li><a href="/" data-navigo>Hem</a></li>
    <li><a href="/faq" data-navigo>FAQ</a></li>
    <li><a href="/kontakt" data-navigo>Kontakt</a></li>
  </ul>`,i.innerHTML=`${t}`,e.updatePageLinks()};function sT(e){switch(e){case"black-panther":default:return _(sC);case"red-panda":return _(sw);case"babirusa":return _(sI)}}const sk=e=>(e.image=sT(e.image),`
    <nav class="userMenu">
  ...
  `),sS=async(e,t)=>{let n=document.querySelector(".mainAside");if(!n){k("Kunde ej hitta mainAside",5e3);return}n.innerHTML="";try{if(!sy()){k("Du måste vara inloggad för att se dina uppgifter",5e3),e.navigate("/login");return}let i=(await sh()).find(e=>e.name===t);if(!i){k("Användaren finns inte",5e3);return}n.innerHTML=sk(i),sP(e),e.updatePageLinks()}catch(e){k("Kunde inte hämta användaren",5e3)}},sP=e=>{let t=document.querySelector("#logout");t&&t.addEventListener("click",()=>{sv(e),sx()})},sx=()=>{let e=document.querySelector(".mainAside");e&&(e.innerHTML="")},sN=async e=>{if(!document.querySelector(".mainAside"))return;let t=sb();null!==t&&(await sS(e,t),await sR(e),e.updatePageLinks())},sR=async e=>{if(!sy())return;let t=document.querySelector(".allUsers");if(!t){k("Det blev fel, försök igen",5e3);return}try{let n=await sh();t.innerHTML="<h3>Alla användare</h3><ul class='userList'></ul>";let i=t.querySelector(".userList");if(!i)return;n.forEach(e=>{let t=document.createElement("li"),n=document.createElement("a");n.href=`/user/${e.name}`,n.setAttribute("data-navigo",""),n.innerText=e.name,i.appendChild(t),t.appendChild(n)}),e.updatePageLinks(),function(e){let t=document.querySelector(".userList");t&&t.addEventListener("click",t=>{t.preventDefault();let n=t.target.innerText;e.navigate(`/user/${n}`)})}(e)}catch(e){console.error(e),k("Kunde inte hämta användare",5e3)}};async function sL(e){var t;let n=document.querySelector("#regUserName").value,i=document.querySelector("#regPassword").value,r=document.querySelector("#confirmPassword").value,s=document.querySelector('input[name="profileImage"]:checked');await sD(n,i,r)&&sc((t=s.value,{name:n,password:i,id:P(),image:t||"babirusa"})).then(()=>localStorage.setItem("login",n)).then(()=>e.navigate(`/user/${n}`)).then(()=>k("Användare skapad",5e3)).then(()=>sE(e)).then(()=>sN(e)).catch(e=>{console.error("Registration error:",e),k("Ett fel uppstod under registreringen",5e3)})}async function sD(e,t,n){return sm.isUserNameValid(e)?sm.isInputEmpty(e)||sm.isInputEmpty(t)||sm.isInputEmpty(n)?(k("Alla fälten måste vara ifyllda",5e3),!1):sm.isPasswordValid(t)?sm.isPasswordMatch(t,n)?!await sm.isUserNameTaken(e)||(k("Användarnamnet är redan taget",5e3),!1):(k("Lösenorden matchar inte",5e3),!1):(k("Lösenordet måste vara minst 6 tecken långt",5e3),!1):(k("Användarnamnet får bara innehålla bokstäver,siffror och understräck",5e3),!1)}async function sA(e,t){let n=document.querySelector(".mainContent");if(n){n.innerHTML="";try{let i=(await sh()).find(e=>e.name===t),r=sb();if(i?.name!==r){k("Du kan bara redigera din egen profil",5e3),e.navigate(`/user/${r}`);return}if(!i){k("Användaren finns inte",5e3);return}n.innerHTML=`
        <div class="editUser">
        ...
        `,sO(e,i),e.updatePageLinks()}catch(e){k("Kunde inte hämta användaren",5e3)}}}const sO=(e,t)=>{let n=document.querySelector("#editUpdate"),i=document.querySelector("#editDelete");n&&i&&(n.addEventListener("click",async n=>{n.preventDefault();let i=document.querySelector('input[name="profileImage"]:checked'),r=document.querySelector("#editPassword").value;if(r!==document.querySelector("#confirmEditPassword").value){k("Lösenorden matchar inte",5e3);return}let s={id:t.id,name:t.name,image:i?i.value:"black-panther",password:r||t.password};await su(s),e.navigate(`/user/${s.name}`),k("Profilen uppdaterad",5e3),T(!1,"#editUserContainer")}),i.addEventListener("click",async n=>{n.preventDefault(),await sd(t.name),sv(e),e.navigate("/login"),k("Användaren borttagen",5e3),T(!1,"#editUserContainer")}),S(".editImageRadio",".editImageLabel"))},sM="threadsv2";async function sq(){let e=r8(sa,sM);try{let t=await si(e);if(!t.exists())return k("Inga trådar hittades",5e3),[];{let e=[];return t.forEach(t=>{let n=t.val();e.push(n)}),e}}catch(e){return k("Kunde inte hämta trådar, testa igen",5e3),[]}}async function sF(e){let t=r8(sa,sM);try{await sn(se(t),e)}catch(e){k("Kunde inte skapa tråd, testa igen",5e3),console.log(e)}}async function sH(e){let t=r8(sa,sM),n=await si(t);if(!n.exists())return null;let i=null;return n.forEach(t=>{let n=t.val();if(n.id===e)return i=n,!0}),i}const sU="commentsv2";async function s$(){let e=r8(sa,sU);try{let t=await si(e);if(!t.exists())return[];{let e=[];return t.forEach(t=>{let n=t.val();e.push(n)}),e}}catch(e){return k("Kunde inte hämta kommentarer, testa igen",5e3),[]}}async function sB(e){let t=r8(sa,sU);try{await se(t,e)}catch(e){k("Kunde inte skapa kommentar, testa igen",5e3),console.log(e)}}async function sW(e){let t=await sj(e);if(!t){k("Kunde inte hitta kommentar, testa igen",5e3);return}let n=r8(sa,`${sU}/${t}`);try{await st(n)}catch(e){k("Kunde inte ta bort kommentar, testa igen",5e3),console.log(e)}}async function sj(e){let t=r8(sa,sU),n=await si(t);if(!n.exists())return null;let i=null;return n.forEach(t=>{t.val().id===e&&(i=t.key)}),i}async function sz(){let e=r8(sa,"forumv2");try{let t=await si(e);if(!t.exists())return k("Inga forum hittades",5e3),[];{let e=[];return t.forEach(t=>{let n=t.val();e.push(n)}),e}}catch(e){return k("Kunde inte hämta data",5e3),[]}}async function sV(e,t){let n=document.querySelector(".userProfileComments");if(n){n.innerHTML="";try{if(!sy()){k("Du måste vara inloggad för att se profiler",5e3);return}for(let i of(await s$()).filter(t=>t.userId===e.id).sort((e,t)=>t.timeStamp-e.timeStamp).slice(0,3)){let r=await sH(i.threadId),s=(await sz()).find(e=>e.id===r?.forumId);if(!r||!s)return;n.innerHTML+=function(e,t,n,i){let r=E(e.timeStamp),s=t.name===sb();return`
    ...
    `;let s=i.querySelector(".deleteUserComment"),o=i.querySelector(".cancelDeleteComment");s&&o&&(s.addEventListener("click",async()=>{try{await sW(e),i.remove()}catch(e){k("Kunde inte radera inlägget",5e3),console.log(e)}}),o.addEventListener("click",()=>{r.innerHTML=`
    ...
    `,sK(t,n)}))}(parseInt(r),e,t)})}),i.forEach(e=>{e.addEventListener("click",async t=>{let n=e.getAttribute("data-comment-id");n&&(parseInt(n),function(){let e=document.querySelector(".editUserComment");e&&e.addEventListener("click",async t=>{e.getAttribute("data-comment-id")&&k("Funktionen är inte implementerad",5e3)})}())})})}async function sY(e,t){let n=document.querySelector(".userProfileThreads");if(n){n.innerHTML="";try{let i=(await sq()).filter(t=>t.userId===e.id).sort((e,t)=>t.timeStamp-e.timeStamp).slice(0,3);if(0===i.length)return;for(let e of(n.innerHTML="<h2>Trådar</h2>",i))n.innerHTML+=`
    <div class="thread">
            <a href="/threads/${e.id}" data-navigo>${e.title}</a>
    </div>
    `;t.updatePageLinks()}catch(e){console.error(e),k("Något gick fel, försök igen senare",5e3)}}}async function sG(e,t){let n=document.querySelector(".mainContent");if(n){n.innerHTML="";try{sy()||k("Du måste vara inloggad för att se profiler",5e3);let i=(await sh()).find(t=>t.name===e);if(!i){k("Användaren finns inte",5e3);return}n.innerHTML=(i.image=sT(i.image),`
    <h1> Profil </h1>
...
`),sY(i,t),sV(i,t),t.updatePageLinks()}catch(e){k("Något gick fel, försök igen",5e3)}}}const sQ=()=>{let e=document.querySelector(".mainFooter");if(!e)return;let t=`
  <ul class="footerMenu">
    ...
    &copy; Omnitalk
  `;e.innerHTML=t},sJ=document.querySelector("#posts");function sX(e,t,n){for(let i of(sZ(),e))sh().then(e=>e.find(e=>e.id===i.userId)).then(e=>{!function(e,t,n,i){sJ.classList.remove("hide");let r=s0("article","post"),s=s0("div","postHeader"),o=s0("div","postSubject"),a=document.createElement("a");a.setAttribute("href",`/topic/thread/${e.threadId}`),a.setAttribute("data-navigo","");let l=s0("div","postDate"),h=s0("div","postBody"),c=s0("div","postUserInfo"),u=s0("a","postUserName");u.setAttribute("href",`/user/${i.name}`),u.setAttribute("data-navigo","");let d=document.createElement("div"),p=s0("img","postUserImg"),f=s0("div","postText"),_=document.createElement("p"),m=s0("div","postFooter"),g=document.createElement("div"),v=s0("a","postTopic");v.setAttribute("href",`/topic/${t}`),v.setAttribute("data-navigo","");let y=document.createElement("div"),b=s0("a","postFooterLink"),C=s0("a","postFooterLink");b.setAttribute("href","#"),b.setAttribute("data-navigo",""),C.setAttribute("href","#"),C.setAttribute("data-navigo",""),a.innerText=n;let w=E(e.timeStamp);l.innerText=`${w.time} | ${w.date}`,u.innerText=i.name,p.src=sT(i.image),_.innerText=e.comment,v.innerText=t;let I=i.name===sb();b.innerHTML=`<button class="editUserComment" data-comment-id="${e.id}" ${I?"":'style="display:none;"'}>Redigera</button>`,C.innerHTML=`<button class="deleteUserComment" data-comment-id="${e.id}" ${I?"":'style="display:none;"'}>Radera</button>`,sJ.append(r),r.append(s,h,m),s.append(l,o),o.append(a),h.append(c,f),c.append(u,d),d.append(p),f.append(_),m.append(g,y),g.append(v),y.append(b,C)}(i,t,n,e)})}function sZ(){sJ.innerHTML=""}function s0(e,t){let n=document.createElement(e);return void 0!==t&&n.classList.add(t),n}function s1(e){return 1===e.length?e:e.sort((e,t)=>t.timeStamp-e.timeStamp)}function s2(e,t,n){for(let n of e.slice(0,5))s$().then(s1).then(e=>e.find(e=>e.threadId===n.id)).then(e=>{!function(e,t,n){d=e.title,n.id;let i=document.createElement("div"),r=document.createElement("h4"),s=document.createElement("a");s.setAttribute("id",e.id.toString()),s.setAttribute("href",`/thread/${e.id}`),s.setAttribute("data-navigo",""),s.setAttribute("title",n.title);let o=document.createElement("p");document.createElement("p"),s.innerText=e.title,void 0!==t&&(o.innerText=t.comment.slice(0,50)+"..."),s3.append(i),i.append(r,o),r.append(s)}(n,e,t)})}const s3=document.querySelector(".subjects");async function s5(e,t){let n=parseInt(e),i=document.querySelector(".mainContent");if(i){i.innerHTML="";try{let e=(await sq()).filter(e=>e.forumId===n),i=(await sz()).find(e=>e.id===n);if(!i)return;s2(e,i,t)}catch(e){k("Kunde inte hämta trådar",5e3)}}}async function s4(e,t){let n=parseInt(e),i=document.querySelector(".mainContent");if(i){i.innerHTML="";try{let e=(await s$()).filter(e=>e.threadId===n),t=(await sq()).find(t=>t.id===e[0].threadId);if(!t)return;let i=t.title,r=await sz(),s=t.forumId,o=r.find(e=>e.id===s)?.title;if(!o)return;sX(e,o,i)}catch(e){k("Kunde inte hämta kommentarer",5e3)}}}s3.addEventListener("click",e=>{e.preventDefault(),sZ();let t=parseInt(e.target.id),n=e.target.title;s$().then(e=>e.filter(e=>e.threadId===t)).then(s1).then(e=>sX(e,n,d))}),document.querySelector("#createThreadFormContainer");const s6=document.querySelector("#topic"),s9=document.querySelector("#topicHeader");async function s8(e){let t=await sz();document.querySelector(".topicsMenuWrapper").innerHTML="",function(e,t){for(let n of e)(function(e,t){let n=document.querySelector(".topicsMenuWrapper"),i=document.createElement("div");i.classList.add("topicMenubox");let r=document.createElement("a");r.setAttribute("id",e.id.toString()),r.setAttribute("href",`/topic/${e.id}`),r.setAttribute("data-navigo",""),r.innerText=e.title,n.append(i),i.append(r),r.addEventListener("click",n=>{if(n.preventDefault(),sy()){n.target.id;let i=document.createElement("h2"),r=document.createElement("p");r.classList.add("topicDesc"),i.innerText=e.title,r.innerText=e.description,function(){s6.classList.remove("hide"),s6.classList.add("flex"),document.querySelector(".startWrapper");let e=document.querySelector("#posts"),t=document.querySelector(".subjects");e.innerHTML="",t.innerHTML="",s9.innerHTML="";let n=document.querySelector(".userContainer"),i=document.querySelector(".userProfileComments");n&&(n.innerHTML="",i&&(i.innerHTML=""))}(),s9.append(i,r),sq().then(t=>t.filter(t=>t.forumId===e.id)).then(n=>s2(n,e,t))}else{k("Du måste vara inloggad för att se inlägg!");return}t.updatePageLinks()})})(n,t)}(t,e)}async function s7(e,t){let n=document.querySelector("#postSendButton");n&&n.addEventListener("click",async n=>{n.preventDefault();let i=await oe(e);if(!i)return;let r=await ot(i);r&&(sF(i),sB(r),t.navigate(`/thread/${i.id}`))})}async function oe(e){let t=sb();if(!t){k("Du måste vara inloggad för att skapa en tråd");return}try{let n=await sh(),i=n.find(e=>e.name===t)?.id;if(!i||!document.querySelector("#createThreadForm"))return;let r=document.querySelector("#subjectHeaderInput").value,s=parseInt(e);if(!r){k("Du måste ange ett ämne");return}return function(e,t,n){let i=Date.now();return{title:e,id:P(),userId:t,forumId:n,timeStamp:i}}(r,i,s)}catch(e){k("Något gick fel, testa igen",5e3)}}async function ot(e){let t=e.userId,n=e.id,i=document.querySelector("#postText").value;if(!i){k("Du måste skriva något i inlägget");return}return function(e,t,n){let i=Date.now();return{id:P(),comment:e,timeStamp:i,threadId:t,userId:n}}(i,n,t)}async function on(e){sE(e),await sN(e),sQ(),await s8(e)}async function oi(e){sy()?(await on(e),function(){let e=document.querySelector("#mainContent");e&&(e.innerHTML="",e.innerHTML=`
...
`)}()):e.navigate("/login")}async function or(e){sy()?e.navigate("/"):(!function(e){let t=document.querySelector(".mainContent");t&&(t.innerHTML="",t.innerHTML=`
    <div class="login">
        <h1>Login</h1>
        <form>
    ...
    `,function(e){let t=document.querySelector("#login"),n=document.querySelector("#register");t&&!t.getAttribute("data-listener")&&(t.setAttribute("data-listener","true"),t.addEventListener("click",t=>{t.preventDefault(),sg(e)})),n&&!n.getAttribute("data-listener")&&(n.setAttribute("data-listener","true"),n.addEventListener("click",t=>{t.preventDefault(),e.navigate("/register")}))}(e),e.updatePageLinks())}(e),await on(e))}async function os(e){sy()?e.navigate("/"):(!function(e){let t=document.querySelector(".mainContent");t&&(t.innerHTML="",t.innerHTML=`
  <div class="register">
  ...
  <form>
    ...
    `,function(e){let t=document.querySelector("#registerBtn"),n=document.querySelector("#backBtn");function i(t){t.preventDefault(),sL(e)}function r(t){t.preventDefault(),e.navigate("/login")}t?(t.removeEventListener("click",i),t.addEventListener("click",i)):console.error("Register button not found"),n?(n.removeEventListener("click",r),n.addEventListener("click",r)):console.error("Back button not found"),S(".regImageRadio",".regImageLabel")}(e),e.updatePageLinks())}(e),await on(e))}async function oo(e,t){sy()?(await sG(t.data.id,e),await on(e),function(){let e=document.querySelector("#topic"),t=document.querySelector("#posts");e&&t&&(e.classList.remove("flex"),e.classList.add("hide"),t.classList.remove("flex"),t.classList.add("hide"))}()):e.navigate("/login")}async function oa(e,t){sy()?(await sA(e,t.data.id),await on(e)):e.navigate("/login")}async function ol(e,t){sy()?(await s5(t.data.id,e),await function(e,t){let n=document.querySelector("#createThreadFormContainer");n&&(n.innerHTML=`
  ...
  `,s7(e,t),t.updatePageLinks())}(t.data.id,e),await on(e),function(e){let t=document.querySelector("#topic");t&&(e?(t.classList.remove("hide"),t.classList.add("flex")):(t.classList.remove("flex"),t.classList.add("hide")))}(!0)):e.navigate("/login")}async function oh(e,t){sy()?(await s4(t.data.id,e),await on(e),function(e){let t=document.querySelector("#posts");t&&(e?t.classList.remove("hide"):t.classList.add("hide"))}(!0)):e.navigate("/login")}"undefined"!=typeof self&&self,function(e){e.on({"/":()=>{oi(e)},"/login":()=>{or(e)},"/register":()=>{os(e)},"/user/:id":t=>{oo(e,t)},"/user/:id/edit":t=>{oa(e,t)},"/faq":()=>{!function(){let e=document.querySelector(".mainContent");e&&(e.innerHTML="",e.innerHTML=`
