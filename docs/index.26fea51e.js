 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n4{constructor(e){this.collection_=e,this.last_=null}get(){let e=this.collection_.get(),t=Object.assign({},e);return this.last_&&tH(this.last_,(e,n)=>{t[e]=t[e]-n}),this.last_=e,t}}class n6{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new n4(e),tj(this.reportStats_.bind(this),Math.floor(1e4+2e4*Math.random()))}reportStats_(){let e=this.statsListener_.get(),t={},n=!1;tH(e,(e,i)=>{i>0&&e_(this.statsToReport_,e)&&(t[e]=i,n=!0)}),n&&this.server_.reportStats(t),tj(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}function n9(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function n8(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function n7(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}(g=w||(w={}))[g.OVERWRITE=0]="OVERWRITE",g[g.MERGE=1]="MERGE",g[g.ACK_USER_WRITE=2]="ACK_USER_WRITE",g[g.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function(e,t){if(e.uid)throw Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');let n=t||"demo-project",i=e.iat||0,r=e.sub||e.user_id;if(!r)throw Error("mockUserToken must contain 'sub' or 'user_id' field!");let s=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},e);return[Q(JSON.stringify({alg:"none",type:"JWT"})),Q(JSON.stringify(s)),""].join(".")}(i.mockUserToken,e.app.options.projectId))),r=s,o.repoInfo_=new tJ(`${t}:${n}`,!1,o.repoInfo_.namespace,o.repoInfo_.webSocketOnly,o.repoInfo_.nodeAdmin,o.repoInfo_.persistenceKey,o.repoInfo_.includeNamespaceInQueryParams,!0),r&&(o.authTokenProvider_=r)}(n,...e)}return n}(e9({apiKey:"AIzaSyDpPuITTDAXymL2UCcisK-nGdAAU0",authDomain:"fe23-slutprojekt-userdb.firebaseapp.com",projectId:"fe23-slutprojekt-userdb",databaseURL:"https://fe23-slutprojekt-userdb-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"fe23-slutprojekt-userdb.appspot.com",messagingSenderId:"1056096098177",appId:"1:1056096098177:web:716d9daa8907b6bb1d7a80",measurementId:"G-SJNLBSDKQ7"})),sl="usersv2";async function sh(){let e=r8(sa,sl);try{let t=await si(e);if(!t.exists())return[];{let e=[];return t.forEach(t=>{let n=t.val();e.push(n)}),e}}catch(e){return k("Kunde inte hämta användare, testa igen",5e3),[]}}async function sc(e){let t=r8(sa,sl);try{if(await sf(e.name)){k("Användarnamnet finns redan",5e3);return}await se(t,e)}catch(e){k("Kunde inte skapa användare, testa igen",5e3),console.log(e)}}async function su(e){let t=await sm(e.name);if(console.log(t),t){let n=r8(sa,`${sl}/${t}`);try{await sn(n,e)}catch(e){k("Kunde inte uppdatera användare, testa igen",5e3),console.log(e)}}else k("Användare hittades inte",5e3)}async function sd(e){let t=await sm(e),n=r8(sa,`${sl}/${t}`);try{await st(n)}catch(e){k("Kunde inte ta bort användare, testa igen",5e3),console.log(e)}}async function sp(e,t){let n=r8(sa,sl),i=await si(n);if(!i.exists())return!1;{let n=!1;return i.forEach(i=>{let r=i.val();r.name===e&&r.password===t&&(n=!0)}),n}}async function sf(e){let t=r8(sa,sl),n=await si(t);if(!n.exists())return!1;{let t=!1;return n.forEach(n=>{n.val().userName===e&&(t=!0)}),t}}async function sm(e){let t=r8(sa,sl),n=await si(t);if(!n.exists())return k("Kunde inte hitta användare, testa igen",5e3),null;let i=null;return n.forEach(t=>{if(t.val().name===e)return i=t.key,!0}),i}const s_={isInputEmpty:e=>!e.trim(),isUserNameValid:e=>/^[A-Za-z0-9_]+$/.test(e),isPasswordValid:e=>e.length>=6,isPasswordMatch:(e,t)=>e===t,isUserNameTaken:async e=>!!(await sh()).find(t=>t.name===e)};async function sg(e){let t=document.querySelector("#userName"),n=document.querySelector("#password");if(!t||!n)return;let i=t.value,r=n.value;if(s_.isInputEmpty(i)||s_.isInputEmpty(r)){k("Alla fälten måste vara ifyllda",5e3);return}await sp(i,r)?(localStorage.setItem("login",i),e.navigate(`/user/${i}`),console.log("router",e)):k("Fel användarnamn eller lösenord",5e3)}function sv(e){localStorage.removeItem("login"),e.navigate("/login")}function sy(){return!!localStorage.getItem("login")}function sb(){return localStorage.getItem("login")}var sC={};sC=new URL("black-panther.5ebfe666.png",import.meta.url).toString();var sw={};sw=new URL("red-panda.2102a999.png",import.meta.url).toString();var sI={};sI=new URL("babirusa.78f33283.png",import.meta.url).toString();const sE=e=>{let t;let n=document.querySelector(".mainMenu"),i=document.querySelector("#topMenuUser");if(!n||!i)return;let r=sy(),s=sb();t=r&&s?`<a href=/user/${s} data-navigo>Se profilsida</a>`:'<a href="/login" data-navigo>Logga in</a>',n.innerHTML=`
  ...
  `),sS=async(e,t)=>{let n=document.querySelector(".mainAside");if(!n){k("Kunde ej hitta mainAside",5e3);return}n.innerHTML="";try{if(!sy()){k("Du måste vara inloggad för att se dina uppgifter",5e3),e.navigate("/login");return}let i=(await sh()).find(e=>e.name===t);if(!i){k("Användaren finns inte",5e3);return}n.innerHTML=sk(i),sP(e),e.updatePageLinks()}catch(e){k("Kunde inte hämta användaren",5e3)}},sP=e=>{let t=document.querySelector("#logout");t&&t.addEventListener("click",()=>{sv(e),sx()})},sx=()=>{let e=document.querySelector(".mainAside");e&&(e.innerHTML="")},sN=async e=>{if(!document.querySelector(".mainAside"))return;let t=sb();null!==t&&(await sS(e,t),await sR(e),e.updatePageLinks())},sR=async e=>{if(!sy())return;let t=document.querySelector(".allUsers");if(!t){k("Det blev fel, försök igen",5e3);return}try{let n=await sh();t.innerHTML="<h3>Alla användare</h3><ul class='userList'></ul>";let i=t.querySelector(".userList");if(!i)return;n.forEach(e=>{let t=document.createElement("li"),n=document.createElement("a");n.href=`/user/${e.name}`,n.setAttribute("data-navigo",""),n.innerText=e.name,i.appendChild(t),t.appendChild(n)}),e.updatePageLinks(),function(e){let t=document.querySelector(".userList");t&&t.addEventListener("click",t=>{t.preventDefault();let n=t.target.innerText;e.navigate(`/user/${n}`)})}(e)}catch(e){console.error(e),k("Kunde inte hämta användare",5e3)}};async function sL(e){var t;let n=document.querySelector("#regUserName").value,i=document.querySelector("#regPassword").value,r=document.querySelector("#confirmPassword").value,s=document.querySelector('input[name="profileImage"]:checked');await sD(n,i,r)&&sc((t=s.value,{name:n,password:i,id:P(),image:t||"babirusa"})).then(()=>localStorage.setItem("login",n)).then(()=>e.navigate(`/user/${n}`)).then(()=>k("Användare skapad",5e3)).then(()=>sE(e)).then(()=>sN(e)).catch(e=>{console.error("Registration error:",e),k("Ett fel uppstod under registreringen",5e3)})}async function sD(e,t,n){return s_.isUserNameValid(e)?s_.isInputEmpty(e)||s_.isInputEmpty(t)||s_.isInputEmpty(n)?(k("Alla fälten måste vara ifyllda",5e3),!1):s_.isPasswordValid(t)?s_.isPasswordMatch(t,n)?!await s_.isUserNameTaken(e)||(k("Användarnamnet är redan taget",5e3),!1):(k("Lösenorden matchar inte",5e3),!1):(k("Lösenordet måste vara minst 6 tecken långt",5e3),!1):(k("Användarnamnet får bara innehålla bokstäver,siffror och understräck",5e3),!1)}async function sA(e,t){let n=document.querySelector(".mainContent");if(n){n.innerHTML="";try{let i=(await sh()).find(e=>e.name===t),r=sb();if(i?.name!==r){k("Du kan bara redigera din egen profil",5e3),e.navigate(`/user/${r}`);return}if(!i){k("Användaren finns inte",5e3);return}n.innerHTML=`
    ...
    `;let s=i.querySelector(".deleteUserComment"),o=i.querySelector(".cancelDeleteComment");s&&o&&(s.addEventListener("click",async()=>{try{await sW(e),i.remove()}catch(e){k("Kunde inte radera inlägget",5e3),console.log(e)}}),o.addEventListener("click",()=>{console.log("cancel"),r.innerHTML=`
