...
import { clearAll, clearForStart } from "../../modules/clearContent";
...
export function logoutUser(router: Navigo): void {
  ...
  clearForStart(); // Petras tillägg (tillfälligt inför bättre lösning), för threadboxen syns om man är inne i en tråd och loggar ut
}
