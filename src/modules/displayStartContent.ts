...
const loginContainer = document.querySelector('#login') as HTMLDivElement;
...
export function displayStartContent():void{
  ...
  if (isLoggedIn()) {
    ...
    startText = 'Nedan ser du dina senaste meddelanden. I menyn till höger kan du redigera dina uppgifter.';
